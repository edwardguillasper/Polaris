...
/** Login screen reached from the hamburger menu's Login section. */
public final class LoginActivity extends LocaleAwareActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    underline(forgotPassword);
    forgotPassword.setOnClickListener(v -> showPlaceholderToast());
    ...
    findViewById(R.id.login_continue_button).setOnClickListener(v -> showPlaceholderToast());
  }
