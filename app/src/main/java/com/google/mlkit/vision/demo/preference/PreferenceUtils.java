...
public class PreferenceUtils {
  ...
  public static String getTextToSpeechVoicePreset(Context context) {
    SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
    String prefKey = context.getString(R.string.pref_key_tts_voice);
    return sharedPreferences.getString(
        prefKey, context.getString(R.string.pref_entry_values_tts_voice_default));
  }

  public static float getTextToSpeechPitch(Context context) {
    SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
    String prefKey = context.getString(R.string.pref_key_tts_pitch);
    return Float.parseFloat(
        sharedPreferences.getString(
            prefKey, context.getString(R.string.pref_entry_values_tts_pitch_normal)));
  }

  public static float getTextToSpeechRate(Context context) {
    SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
    String prefKey = context.getString(R.string.pref_key_tts_speed);
    return Float.parseFloat(
        sharedPreferences.getString(
